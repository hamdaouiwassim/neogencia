<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Build a team of AI models for comprehensive SEO analysis</p>
            </div>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-2xl rounded-3xl border border-gray-200/50 dark:border-gray-700/50">
                <form method="POST" action="{{ route('seo-squads.store') }}" id="squad-form">
                    @csrf
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                   ...
                                   placeholder="e.g. My SEO Analysis Squad">
                            @error('name')
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                      class="w-full rounded-xl border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all"
                                      placeholder="Optional description of what this squad does">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div class="flex items-center gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <a href="{{ route('seo-squads.index') }}" class="px-4 py-2.5 text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 font-semibold rounded-xl transition-all">
                                Cancel
                            </a>
                        </div>
                    </div>
    ...
    <script>
            ...
            row.innerHTML = `
                ...
                <div>
                    ...
                    <textarea name="models[${modelRowCount}][system_prompt]" rows="2"
                              class="w-full rounded-xl border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 text-sm"
                              placeholder="Override default system prompt for this model-task combination"></textarea>
                </div>
            `;
        ...
        // Add first model row on page load
