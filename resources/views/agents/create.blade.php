    ...
    <div class="py-8 md:py-12">
        <div class="max-w-4xl mx-auto sm:px-4 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-2xl sm:rounded-3xl border border-gray-200 dark:border-gray-700">
                ...
                <form method="POST" action="{{ route('agents.store') }}" enctype="multipart/form-data" class="p-8 md:p-10" x-data="{ mode: '{{ old('execution_mode', 'external') }}' }">
                    @csrf
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">{{ __('Hosted agents run on Neogencia via LangChain; build flows in Langflow and paste the flow ID.') }}</p>
                            ...
                            <div x-show="mode === 'hosted'" x-cloak class="space-y-4 rounded-xl border border-indigo-200 dark:border-indigo-800 bg-indigo-50/50 dark:bg-indigo-950/20 p-4">
                                <p class="text-sm text-gray-700 dark:text-gray-300">
                                    {{ __('Open Langflow to build your flow:') }}
                                ...
                                <div>
                                    ...
                                    <x-text-input id="langflow_flow_id" class="block w-full mt-1" type="text" name="langflow_flow_id" :value="old('langflow_flow_id')" placeholder="e.g. UUID from Langflow" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="langflow_revision" class="block w-full mt-1" type="text" name="langflow_revision" :value="old('langflow_revision')" />
                                    <x-input-error :messages="$errors->get('langflow_revision')" class="mt-2" />
                                </div>
                                <div>
                                    <x-input-label for="langsmith_project" :value="__('LangSmith project name (optional)')" />
                                    <x-text-input id="langsmith_project" class="block w-full mt-1" type="text" name="langsmith_project" :value="old('langsmith_project')" placeholder="neogencia-agents" />
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400" x-show="mode === 'hosted'" x-cloak>{{ __('Optional for hosted agents; a marketplace link will be set automatically.') }}</p>
                            </div>
